...
public class IBDBGeneratorCentralDbTest {
	...
	public void testGenerateDatabaseNewCustomCrop() throws Exception {
		...
		Mockito.doNothing().when(moleGenerator).runScriptsInDirectory(Matchers.anyString(), Matchers.any(File.class));
	...
	public void testGenerateDatabaseCustomCropExistsAlready() throws Exception {
		...
		Mockito.verify(moleGenerator, Mockito.times(0)).runScriptsInDirectory(Matchers.anyString(), Matchers.any(File.class));
	}
