...
public class GermplasmListTreeComponentTest {
	...
	public void setUp() throws Exception {
		...
		Mockito.when(this.germplasmListManager.getAllTopLevelLists(GermplasmListTreeComponentTest.PROGRAM_UUID)).thenReturn(this.germplasmLists);
	...
	public void testCreateGermplasmListTreeReturnsATreeWithOnlyTheRootFolderAsAnItem() throws MiddlewareQueryException {
		...
		Mockito.when(this.germplasmListManager.getAllTopLevelLists(GermplasmListTreeComponentTest.PROGRAM_UUID)).thenThrow(new MiddlewareQueryException("This is an error"));
