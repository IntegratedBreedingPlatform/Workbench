...
/*			// Show the expected range widget if the chosen scale has a numeric datatype
			...
			$scope.saveFormula = function(e, variable) {
				...
				if ($scope.avForm.$valid) {
					...
					variablesService.addVariable(variable).then(function() {// TODO: Modificar para que salve la formula. Agregar nuevo metodo. addFormula
						variableStateService.reset();
