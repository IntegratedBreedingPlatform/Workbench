...
package org.generationcp.ibpworkbench.cross.study.traitdonors.main.pojos;
...
public class TraitItem {
	...
	/**
	 * Hashcode is overriden here so that insertion into Vaadin tables makes use of the unique ListSet that backs them. Standard Variable
	 * Name is a unique key and used as such.
	 *
	 */
	@Override
	public int hashCode() {
	...
	/**
	 * Equals is overriden here so that insertion into Vaadin tables makes use of the unique ListSet that backs them. Standard Variable Name
	 * is a unique key and used as such.
	 *
	 */
	@Override
