...
/**
 * <b>Description</b>: This class contains convenience methods for navigation management.
 *
 * <br>
 * <br>
 *
...
public final class NavManager {
	...
	public static void navigateApp(Window window, String viewId, boolean isLinkAccessed) {
		NavManager.navigateApp(window, viewId, isLinkAccessed, null);
	}
	...
	public static void navigateApp(Window window, String viewId, boolean isLinkAccessed, String breadCrumbLabel) {
		...
		if (crumbTrail.getCrumbTrailList().isEmpty() || !crumbTrail.getLastBreadCrumbUri().equals(viewId)) {
			...
			try {
				...
				NavManager.LOG.error("NumberFormatException", e);
				NavManager.showConfigError(window);
			} catch (InternationalizableException e) {
				NavManager.LOG.error("InternationalizableException", e);
				MessageNotifier.showError(window, e.getCaption(), e.getDescription());
			} catch (Exception e) {
				NavManager.LOG.error("Exception", e);
	...
	private static void showConfigError(Window window) {
		MessageNotifier.showError(window, NavManager.messageSource.getMessage(Message.CONFIG_ERROR),
				"<br />" + NavManager.messageSource.getMessage(Message.CONTACT_ADMIN_ERROR_DESC));
	}
