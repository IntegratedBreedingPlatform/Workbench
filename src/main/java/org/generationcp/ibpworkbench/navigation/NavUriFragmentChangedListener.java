...
/**
 * <b>Description</b>: Handles URI fragment changes for the application and calls mapped Listeners for the view. Browser back button,
 * bookmark access and manual user input on the address bar events are handled by this listener.
 *
 * <br>
 * <br>
 *
...
public class NavUriFragmentChangedListener implements FragmentChangedListener {
	...
	public void fragmentChanged(FragmentChangedEvent source) {
		...
		NavUriFragmentChangedListener.LOG.debug("Workbench Fragment updated. Fragment[" + u.getFragment() + "]");
	}
