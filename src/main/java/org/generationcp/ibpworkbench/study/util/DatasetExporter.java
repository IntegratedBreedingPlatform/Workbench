...
public class DatasetExporter {
	 ...
	 */
	private void createDescriptionSheet(HSSFSheet descriptionSheet, Study study, String name)
					throws DatasetExporterException {
	 ...
	 */
	private int populateStudyConditions(HSSFSheet descriptionSheet, Study study) {
