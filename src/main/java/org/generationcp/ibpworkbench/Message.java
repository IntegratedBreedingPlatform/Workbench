...
public enum Message {
	...
	SPECIFY_ENTRIES,SELECT_TRAITS,SELECT_ENVIRONMENTS,HEAD_TO_HEAD_CHECK_TRAITS,HEAD_TO_HEAD_CHECK_ANALYSIS,HEAD_TO_HEAD_SELECT_TRAITS,HEAD_TO_HEAD_TAG,HEAD_TO_HEAD_NO_OF_ENVS,HEAD_TO_HEAD_DIRECTION,
