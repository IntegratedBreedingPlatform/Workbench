...
public enum Message {
    ...
    ,MANAGE_NURSERIES
    ,NURSERY_TEMPLATE,
    HEAD_TO_HEAD_LAUNCH,CLICK_TO_LAUNCH_HEAD_TO_HEAD,
    CLICK_TO_LAUNCH_NURSERY_TEMPLATE, SINGLE_SITE_ANALYSIS_LINK, LOGIN_SUBTITLE, FIELDBOOK_CREATE, BREEDING_PLANNER_MABC, MBDT_MABC, OPTIMAS_MARS, MULTI_SITE_ANALYSIS_MANAGER, CLICK_TO_LAUNCH_USER_TOOLS, REMEMBER_ME, DELETE_PROJECT_LINK
}
