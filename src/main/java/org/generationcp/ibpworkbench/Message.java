...
public enum Message {
    ...
    ,GXE_TRAIT_TABLE_HEADER
    ,GXE_TRAIT_TABLE_DESCRIPTION
    ...
    ,META_SELECT_FACTORS
    ,EXPORT_DATA
    ,SSA_NON_NUMERIC_CATEGORICAL_VAR_ERROR
    ...
    , MOVE_PUBLIC_LISTS_NOT_ALLOWED
    , MOVE_PUBLIC_STUDIES_NOT_ALLOWED
    ...
    ,BROWSE
    ,BV_UPLOAD_HEADER
    ,BV_UPLOAD_DESCRIPTION
    ,BV_UPLOAD_ZIP
    ,BV_SELECT_STUDY_FOR_UPLOAD
    ,BV_SELECT_STUDY_FOR_UPLOAD_DESCRIPTION
    ,BV_UPLOAD_ERROR_HEADER
    ,BV_UPLOAD_ERROR_INVALID_FORMAT
    ,BV_UPLOAD_SUCCESSFUL_HEADER
    ,BV_UPLOAD_SUCCESSFUL_DESCRIPTION
    ,BV_UPLOAD_ERROR_CANNOT_UPLOAD_MEANS
