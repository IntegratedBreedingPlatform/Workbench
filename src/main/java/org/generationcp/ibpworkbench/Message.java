...
public enum Message {
    ...
    ,RESTORE_IBDB_CONFIRM, BACKUP_IBDB_LINK, BACKUP_IBDB_LINK_DESC, RESTORE_IBDB_LINK_DESC, RESTORE_IBDB_LINK, USER_TOOLS_WINDOW_CAPTION, USER_TOOLS_FORM_CAPTION, ADD, EDIT, USER_TOOLS_LISTSELECT_CAPTION
