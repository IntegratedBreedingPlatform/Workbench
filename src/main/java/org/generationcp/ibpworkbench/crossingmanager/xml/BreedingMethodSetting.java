...
package org.generationcp.ibpworkbench.crossingmanager.xml;
...
public class BreedingMethodSetting implements Serializable {
	...
	public BreedingMethodSetting(Integer methodId, boolean isBasedOnStatusOfParentalLines) {
		super();
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(this.methodId, rhs.methodId)
				.append(this.isBasedOnStatusOfParentalLines, rhs.isBasedOnStatusOfParentalLines).isEquals();
	}
	...
	public String toString() {
		return "BreedingMethodSetting [methodId=" + this.methodId + ", isBasedOnStatusOfParentalLines="
						+ this.isBasedOnStatusOfParentalLines + "]";
	}
