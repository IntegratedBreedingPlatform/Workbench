...
public class UserPasswordValidator extends AbstractValidator {
	...
	private final Field passwordConfirmation;
	...
	public boolean isValid(Object value) {
		if (!StringUtil.isEmpty(this.password.getValue().toString())
				&& !StringUtil.isEmpty(this.passwordConfirmation.getValue().toString())) {
			return this.password.getValue().equals(this.passwordConfirmation.getValue());
		}
