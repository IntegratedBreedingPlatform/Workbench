...
public class SeasonProfile implements Serializable {
	...
	public SeasonProfile(String periodFrom, String periodTo, double avg_MinTemp, double avg_MaxTemp, double avg_Solar, double Total_Rain,
	...
	public String toString() {
		return "SeasonProfile [periodFrom=" + this.PeriodFrom + ", periodTo=" + this.PeriodTo + ", avg_MinTemp=" + this.Avg_MinTemp
