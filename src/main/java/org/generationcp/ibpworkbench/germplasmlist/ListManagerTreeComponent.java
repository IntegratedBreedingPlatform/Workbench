...
package org.generationcp.ibpworkbench.germplasmlist;
...
public class ListManagerTreeComponent extends VerticalLayout implements InternationalizableComponent, InitializingBean, Serializable {
	...
	protected void initializeButtonPanel() {
		...
		this.renameFolderBtn.addListener(new ClickListener() {
		...
		this.addFolderBtn.addListener(new ClickListener() {
		...
		this.deleteFolderBtn.addListener(new ClickListener() {
