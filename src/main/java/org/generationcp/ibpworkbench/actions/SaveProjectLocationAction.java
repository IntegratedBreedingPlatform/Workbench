 ...
 */
@Configurable
public class SaveProjectLocationAction implements ClickListener, ActionListener{

    private static final Logger LOG = LoggerFactory.getLogger(SaveProjectLocationAction.class);
    private static final long serialVersionUID = 1L;

    private ProjectLocationPanel projectLocationPanel;

    public SaveProjectLocationAction(ProjectLocationPanel projectLocationPanel) {
        this.projectLocationPanel = projectLocationPanel;
    }

    @Override
    public void buttonClick(ClickEvent event) {
        projectLocationPanel.validateAndSave();
