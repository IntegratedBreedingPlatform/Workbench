...
import org.generationcp.ibpworkbench.customfields.UploadField;
import org.generationcp.ibpworkbench.listimport.exceptions.GermplasmImportException;
...
import org.generationcp.ibpworkbench.validator.ShowNameHandlingPopUpValidator;
...
public class GermplasmImportFileComponent extends AbsoluteLayout implements InitializingBean, InternationalizableComponent,
	...
	public void addListenersForUploadField() {
		this.uploadComponents.setDeleteButtonListener(new ClickListener() {
