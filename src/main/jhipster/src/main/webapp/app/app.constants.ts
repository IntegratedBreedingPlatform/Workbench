...
export const GERMPLASM_DETAILS_URL = '/ibpworkbench/controller/jhipster#/germplasm-details/';
...
export const COP_ASYNC_PROGRESS_REFRESH_MILLIS = 5000;
...
export const HELP_GERMPLASM_LIST_COP_BETA = 'GERMPLASM_LIST_COP_BETA';
