...
import { GermplasmAttribute, GermplasmDto, GermplasmList, GermplasmName, GermplasmProgenitorsDetails, GermplasmStudy, GermplasmBasicDetailsDto } from '../model/germplasm.model';
