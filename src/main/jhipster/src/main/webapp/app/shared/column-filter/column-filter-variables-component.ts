		...
		<form #f='ngForm'>
			<section class="filter-wrapper">
				<div class="keyword-wrapper">
					<input type="text" class="form-control" [formControl]="queryField" id="keyword" placeholder="{{filter.placeholder || 'Search variables...'}}" autofocus/>
				</div>
			...
			<div *ngIf="this.filter.variables.length === 0"><span>{{filter.description || 'Search for variables that you want to filter'}}</span></div>
			<br/>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<button class="btn btn-default float-right fa fa-minus" (click)="deleteVariable(variable)"></button>
						</div>
					</div>
				</div>
			</div>
